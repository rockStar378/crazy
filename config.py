...
API_KEY = getenv("API_KEY", '30DxNexGenBots5dcf9a') # youtube song api ke 

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/ankitOP/kavyamusic",
)
...
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://telegra.ph/Privacy-Policy-for-kavyamusic-08-14")
