...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("kavyamusic/assets/font2.ttf", 30)
        font = ImageFont.truetype("kavyamusic/assets/font.ttf", 30)
        title_font = ImageFont.truetype("kavyamusic/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("kavyamusic/assets/play_icons.png")
