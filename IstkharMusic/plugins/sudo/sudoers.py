...
from kavyamusic.misc import SUDOERS
from kavyamusic.utils.database import add_sudo, remove_sudo
from kavyamusic.utils.decorators.language import language
from kavyamusic.utils.extraction import extract_user
from kavyamusic.utils.inline import close_markup
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(photo="https://files.catbox.moe/eelcv4.jpg", caption="<b>» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.<b/>\n\n<b>» ɴᴏᴛᴇ:<b/>  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
